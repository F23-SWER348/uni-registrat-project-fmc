...
public class App {
   ...
   public static void main(String[] args) {
      ...
      System.out.println();
      System.out.println();
      System.out.println("We will add students to the course if the student has taken the previous required courses");// بضيف
                                                                                                                      // الطالب
                                                                                                                      // للكورس
                                                                                                                      // اذا
                                                                                                                      // كان
      ...
      math2.getStudent().stream().forEach(e -> System.out.println(e.getName()));// مفروض يطبع بس سيلينا وفاطمة لانو ما
                                                                                // اخدت ماث 1 وهي متطلب اساسي قبل ماث2
      System.out.println();
      ...
      System.out.println(" ");
      staffs.stream().map(e -> new Schedule(e))
            .forEach(x -> System.out.println(x.getStaff().getName() + "    Schedule" + x.toStringStaff() + "\n\n"));// اذا
                                                                                                                    // ما
                                                                                                                    // دخلت
                                                                                                                    // اوقات
                                                                                                                    // راح
      ...
      System.out.println(user.CourseList.toString());
